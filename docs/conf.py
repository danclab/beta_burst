...
html_theme_options = {
   "logo": {
      "image_light": "_static/blacklogo.png",
      "image_dark": "_static/blacklogo.png",
      "text": "betaburst",
   },
    "show_toc_level": 1,
    "external_links": [
...
sphinx_gallery_conf = {
    "doc_module": ("betaburst",),
    'examples_dirs': ['../examples'],   # Path to your tutorials
