...
def burst_data():
    ...
    nb_bursts_ch1 = 100
    burst_data_ch1 = {"waveform": np.random.rand(nb_bursts_ch1, 64), "peak_time": np.random.uniform(0, 10, nb_bursts_ch1), "waveform_times": np.arange(nb_bursts_ch1)}
    
    nb_bursts_ch2 = 250
    burst_data_ch2 = {"waveform": np.random.rand(nb_bursts_ch2, 64), "peak_time": np.random.uniform(0, 10, nb_bursts_ch2), "waveform_times": np.arange(nb_bursts_ch2)}
    
    nb_bursts_ch3 = 95
    burst_data_ch3 = {"waveform": np.random.rand(nb_bursts_ch3, 64), "peak_time": np.random.uniform(0, 10, nb_bursts_ch3), "waveform_times": np.arange(nb_bursts_ch3)}
